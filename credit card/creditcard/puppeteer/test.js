...
(async () => {
  ...
  try {
    await page7.goto('https://api.example.com/'); // Replace with your URL
    ...
    if (spanContent.includes('Master Card')) {
      console.log('TESTCASE:header_contents:success');
    } else {
      console.log('TESTCASE:header_contents:failure');
    }
  } catch (e) {
  ...
  try {
    await page8.goto('https://api.example.com/'); // Replace with your URL
    ...
    if (nameNumberContent.includes('Card Number') && nameNumberContent.includes('8050 2030 3020 5040') && nameNumberContent.includes('Cristiano Ronaldo')) {
      console.log('TESTCASE:name_number_contents:success');
    } else {
      console.log('TESTCASE:name_number_contents:failure');
    }
  } catch (e) {
    console.error('Error:', e);
  }
  ...
  try {
    await page9.goto('https://api.example.com/'); // Replace with your URL
    ...
    if (validDateContent.includes('Valid Thru') && validDateContent.includes('05/28')) {
      console.log('TESTCASE:valid_date_contents:success');
    } else {
      console.log('TESTCASE:valid_date_contents:failure');
    }
    ...
    const page17 = await browser.newPage();
      try {
        ...
        if (containerStyle.trim().includes('100')) {
          console.log('TESTCASE:container_zIndex:success');
        } else {
          console.log('TESTCASE:container_zIndex:failure');
        }
        }catch (e) {
          console.log('An error occurred:', e);
        }
